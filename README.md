[![Build Status](https://travis-ci.org/resphantom/tgenv.svg?branch=master)](https://travis-ci.org/resphantom/tgenv)
...
1. Check out tgenv into any path (here is `${HOME}/.tgenv`)
  ...
  ```bash
  $ git clone https://github.com/resphantom/tgenv.git ~/.tgenv
  ```
...
## LICENSE
- [tgenv itself](https://github.com/resphantom/tgenv/blob/master/LICENSE)
